...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  6 21:06:33 2017
...
def ts_rank(x, window=10):
    return x.rolling(window).apply(rolling_rank)
...
class Alphas(object):
    ...
    def alpha046(self):
        inner = (((delay(self.close, 20) - delay(self.close, 10)) / 10) - ((delay(self.close, 10) - self.close) / 10)).copy()
    ...
    def alpha060(self):
        ...
        inner = (((self.close - self.low) - (self.high - self.close)) * self.volume / divisor).copy()
